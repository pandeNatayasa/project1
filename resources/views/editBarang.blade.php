					...
					<div class="col s12 m12 l12 padding-on-med-and-down " style="margin-left:70px;margin-right:70px;margin-bottom: 70px;">
						...
						<div class="row">
							<div class="col s12 m12 l12">
								<h3 class="header-color-text center"> Edit Data Barang</h3>
							</div>
						</div>
						<!--End Header Tabel-->
						<!--////////////////////////////////////////////////////////////-->
						<div class="row">
							<form class="col s12" method="POST" action="{{ action('barang@update',$data['id']) }}">
							{{ csrf_field() }}	
									...
									<div class="input-field col s12">
										<table width="60%">
											...
											<tr>
												<td>Jumlah Barang</td>
												<td>
													<input type="text" name="jumlahBarang" value="{{$data->jumlah}}">
