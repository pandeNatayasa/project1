					...
					<div class="col s12 m12 l12 padding-on-med-and-down " style="margin-left:70px;margin-right:70px;margin-bottom: 70px;">
						...
						<div class="row">
							<div class="col s12 m12 l12">
								<h3 class="header-color-text center"> Edit Data Pegawai</h3>
							</div>
						</div>
						<!--End Header Tabel-->
						<!--////////////////////////////////////////////////////////////-->
						<div class="row">
							<form class="col s12" method="POST" action="{{ action('pembeli@update',$data['id']) }}">
							{{ csrf_field() }}	
									...
									<div class="input-field col s12">
										<table width="60%">
											...
											<tr>
												<td>No Telepun</td>
												<td>
													<input type="text" name="noTlp" value="{{$data->no_telp}}">
													<span class="red-text">{{ $errors->first('noTlp')}}</span>
												</td>
											</tr>
										</table>
										<div class="row right" style="margin-top: 30px;">
											<div class="col s2">
												<input class="btn waves-effect waves-light side-nav-background" type="submit" name="submit" value="save">
											</div>
										</div>	
									</div>
								</div>
