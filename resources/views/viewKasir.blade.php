            ...
            <div class="row white">
                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        <h3 class="header-color-text center">Data Pegawai</h3>
                    </div>
                </div>
                <!--End Header Content-->
                <!--////////////////////////////////////////////////////////////-->
                ...
                <div class="row col s12" style="margin-bottom:10px;">
                        <div class="col s12 m12 l12 white">
                            <a class="btn waves-effect waves-light side-nav-background" href="{{ action('kasir@create')}}" >Tambah Data Pegawai</a>
                                    ...
                                    <div class="input-field col s12">
                                        <table class="striped">
                                            <thead class="border-bottom-table teal lighten-2" >
                                                <th class="border-right-table">No Identitas</th>
                                                <th class="border-right-table">Nama</th>
                                                <th class="border-right-table">Alamat</th>
                                                <th class="border-right-table">Jenis Kelamin</th>
                                            ...
                                            @foreach($dataKasir as $data )
                                                <tr>
                                                    <td class="border-right-table">{{$data->no_identitas}}</td>
                                                    <td class="border-right-table">{{$data->nama}}</td>
                                                    <td class="border-right-table">{{$data->alamat}}</td>
                                                    <td class="border-right-table">{{$data->jenis_kelamin}}</td>
                                                    <td class="border-right-table">{{$data->email}}</td>
                                                    <td>
                                                        <a class="btn waves-effect waves-light side-nav-background" href="{{ action('kasir@edit',$data->id) }}">Edit</a>
                                                        <!--<form action="{{ action('kasir@destroy',$data->id) }}" method="POST" style="display: inline-block;">
                                                            {{csrf_field()}}
                                                        ...
                                                        <div class="modal" id="modal1">
                                                            ...
                                                            <div class="modal-footer" style="margin-bottom: 20px;">
                                                                <div class="row">
                                                                    <form action="{{ action('kasir@destroy',$data->id) }}" method="POST">
                                                                        {{csrf_field()}}
                                                                        <input type="hidden" name="_method" value="delete">
